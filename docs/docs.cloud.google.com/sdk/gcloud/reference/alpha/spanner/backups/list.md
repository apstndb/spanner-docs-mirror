---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/backups/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/backups/list
title: gcloud alpha spanner backups list
...
gcloud alpha spanner backups list - list existing Cloud Spanner Cloud Spanner backups

SYNOPSIS

`gcloud alpha spanner backups list` \[ `  --database  ` = `  DATABASE  ` \] \[ `  --instance  ` = `  INSTANCE  ` \] \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To list existing backups for the instance, run:
    ...
    gcloud alpha spanner backups list --instance=INSTANCE_NAME

To list existing backups for a database, run:

    gcloud alpha spanner backups list --instance=INSTANCE_NAME --database=DATABASE
