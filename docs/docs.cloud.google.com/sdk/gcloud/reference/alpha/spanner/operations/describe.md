---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/operations/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/operations/describe
title: gcloud alpha spanner operations describe
...
`gcloud alpha spanner operations describe` `  OPERATION-ID  ` ( `  --instance  ` = `  INSTANCE  ` | `  --instance-config  ` = `  INSTANCE_CONFIG  ` ) \[ `  --backup  ` = `  BACKUP  ` \] \[ `  --database  ` = `  DATABASE  ` \] \[ `  --instance-partition  ` = `  INSTANCE_PARTITION  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
