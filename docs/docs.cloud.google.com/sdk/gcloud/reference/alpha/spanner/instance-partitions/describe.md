---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/instance-partitions/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/instance-partitions/describe
title: gcloud alpha spanner instance-partitions describe
...
gcloud alpha spanner instance-partitions describe - describe a Spanner instance partition

SYNOPSIS

`gcloud alpha spanner instance-partitions describe` ( `  INSTANCE_PARTITION  ` : `  --instance  ` = `  INSTANCE  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
