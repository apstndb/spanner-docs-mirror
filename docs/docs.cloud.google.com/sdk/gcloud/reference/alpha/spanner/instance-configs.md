---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/instance-configs
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/instance-configs
title: gcloud alpha spanner instance-configs
...
gcloud alpha spanner instance-configs - manage Cloud Spanner instance configs

SYNOPSIS

`gcloud alpha spanner instance-configs` `  COMMAND  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]
