---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/databases/ddl/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/databases/ddl/describe
title: gcloud alpha spanner databases ddl describe
...
gcloud alpha spanner databases ddl describe - describe the DDL for a Cloud Spanner database

SYNOPSIS

`gcloud alpha spanner databases ddl describe` ( `  DATABASE  ` : `  --instance  ` = `  INSTANCE  ` ) \[ `  --include-proto-descriptors  ` \] \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To describe the DDL for a given Cloud Spanner database, run:
    ...
    gcloud alpha spanner databases ddl describe my-database-id --instance=my-instance-id
