---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/databases/ddl
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/databases/ddl
title: gcloud alpha spanner databases ddl
...
`gcloud alpha spanner databases ddl` `  COMMAND  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]
