---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/databases/sessions/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/databases/sessions/delete
title: gcloud alpha spanner databases sessions delete
...
To delete a Cloud Spanner session, run:
    ...
    gcloud alpha spanner databases sessions delete my-session-id --instance=my-instance-id --database=my-database-id
