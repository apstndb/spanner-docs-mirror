---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/databases/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/databases/update
title: gcloud alpha spanner databases update
description: Offers tools and libraries that allow you to create and manage resources across Google Cloud.
data_source: docs.cloud.google.com
update_time: "2026-05-05T17:52:05Z"
---
...
`gcloud alpha spanner databases update` ( `  DATABASE  ` : `  --instance  ` = `  INSTANCE  ` ) \[ `  --async  ` \] \[ `  --clear-kms-keys  ` | `  --[no-]enable-drop-protection  ` | `  --kms-keys  ` = `  KMS_KEY  ` , \[ `  KMS_KEY  ` , …\]\] \[ `  GCLOUD_WIDE_FLAG …  ` \]
...
To enable database deletion protection on a Cloud Spanner database 'my-database', run:
    ...
    gcloud alpha spanner databases update my-database --enable-drop-protection

To disable database deletion protection on a Cloud Spanner database 'my-database', run:

    gcloud alpha spanner databases update my-database --no-enable-drop-protection

To update KMS key references for a Cloud Spanner database 'my-database', run:

    gcloud alpha spanner databases update my-database --kms-keys="KEY1,KEY2"

To remove all KMS key references and revert a Cloud Spanner database 'my-database' to Google-managed encryption, run:

    gcloud alpha spanner databases update my-database --clear-kms-keys
