---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/instance-configs/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/alpha/spanner/instance-configs/delete
title: gcloud alpha spanner instance-configs delete
...
`gcloud alpha spanner instance-configs delete` `  INSTANCE_CONFIG  ` \[ `  --etag  ` = `  ETAG  ` \] \[ `  --validate-only  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
