---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/databases/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/databases/describe
title: gcloud beta spanner databases describe
...
`gcloud beta spanner databases describe` ( `  DATABASE  ` : `  --instance  ` = `  INSTANCE  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
