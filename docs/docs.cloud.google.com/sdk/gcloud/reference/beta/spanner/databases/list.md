---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/databases/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/databases/list
title: gcloud beta spanner databases list
...
gcloud beta spanner databases list - list the Cloud Spanner databases contained within the given instance

SYNOPSIS

`gcloud beta spanner databases list` \[ `  --instance  ` = `  INSTANCE  ` \] \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
