---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/samples/backend
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/samples/backend
title: gcloud beta spanner samples backend
...
To run the backend gRPC service for the 'finance' sample app using instance 'my-instance', run:
    ...
    gcloud beta spanner samples backend finance --instance-id=my-instance
