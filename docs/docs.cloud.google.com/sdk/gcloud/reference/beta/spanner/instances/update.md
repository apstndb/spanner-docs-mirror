---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/instances/update
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/instances/update
title: gcloud beta spanner instances update
...
To update the display name of a Cloud Spanner instance, run:
    ...
    gcloud beta spanner instances update my-instance-id --description=my-new-display-name
