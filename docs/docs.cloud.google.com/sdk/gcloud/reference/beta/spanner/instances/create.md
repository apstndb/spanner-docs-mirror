---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/instances/create
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/instances/create
title: gcloud beta spanner instances create
...
To create a Cloud Spanner instance, run:
    ...
    gcloud beta spanner instances create my-instance-id --config=regional-us-east1 --description=my-instance-display-name --nodes=3
