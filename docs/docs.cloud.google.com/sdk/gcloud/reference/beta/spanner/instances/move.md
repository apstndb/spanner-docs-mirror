---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/instances/move
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/instances/move
title: gcloud beta spanner instances move
...
`gcloud beta spanner instances move` `  INSTANCE  ` `  --target-config  ` = `  TARGET_CONFIG  ` \[ `  --target-database-move-configs  ` =\[^:^ `  database-id  ` = `  DATABASE_ID  ` : `  kms-key-names  ` = `  KEY1  ` , `  KEY2  ` , …\]\] \[ `  GCLOUD_WIDE_FLAG …  ` \]
