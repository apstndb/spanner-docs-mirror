---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/instance-partitions/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/beta/spanner/instance-partitions/describe
title: gcloud beta spanner instance-partitions describe
...
gcloud beta spanner instance-partitions describe - describe a Spanner instance partition
...
To describe a Spanner instance partition, run:
    ...
    gcloud beta spanner instance-partitions describe my-instance-partition-id --instance=my-instance-id
