---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/spanner/backup-schedules/describe
uri: https://docs.cloud.google.com/sdk/gcloud/reference/spanner/backup-schedules/describe
title: gcloud spanner backup-schedules describe
...
`gcloud spanner backup-schedules describe` ( `  BACKUP_SCHEDULE  ` : `  --database  ` = `  DATABASE  ` `  --instance  ` = `  INSTANCE  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
