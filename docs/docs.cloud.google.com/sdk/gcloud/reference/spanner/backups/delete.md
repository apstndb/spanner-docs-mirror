---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/spanner/backups/delete
uri: https://docs.cloud.google.com/sdk/gcloud/reference/spanner/backups/delete
title: gcloud spanner backups delete
...
`gcloud spanner backups delete` ( `  BACKUP  ` : `  --instance  ` = `  INSTANCE  ` ) \[ `  GCLOUD_WIDE_FLAG …  ` \]
