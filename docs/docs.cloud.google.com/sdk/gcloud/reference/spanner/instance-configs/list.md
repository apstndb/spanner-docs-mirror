---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/spanner/instance-configs/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/spanner/instance-configs/list
title: gcloud spanner instance-configs list
...
`gcloud spanner instance-configs list` \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  --uri  ` \] \[ `  GCLOUD_WIDE_FLAG …  ` \]
