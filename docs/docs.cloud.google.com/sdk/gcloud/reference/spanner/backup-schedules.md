---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/spanner/backup-schedules
uri: https://docs.cloud.google.com/sdk/gcloud/reference/spanner/backup-schedules
title: gcloud spanner backup-schedules
...
`gcloud spanner backup-schedules` `  COMMAND  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]
