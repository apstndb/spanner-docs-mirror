---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/spanner/databases/splits/list
uri: https://docs.cloud.google.com/sdk/gcloud/reference/spanner/databases/splits/list
title: gcloud spanner databases splits list
...
`gcloud spanner databases splits list` ( `  DATABASE  ` : `  --instance  ` = `  INSTANCE  ` ) \[ `  --filter  ` = `  EXPRESSION  ` \] \[ `  --limit  ` = `  LIMIT  ` \] \[ `  --page-size  ` = `  PAGE_SIZE  ` \] \[ `  --sort-by  ` =\[ `  FIELD  ` , …\]\] \[ `  GCLOUD_WIDE_FLAG …  ` \]
