---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/spanner/databases/set-iam-policy
uri: https://docs.cloud.google.com/sdk/gcloud/reference/spanner/databases/set-iam-policy
title: gcloud spanner databases set-iam-policy
...
`gcloud spanner databases set-iam-policy` ( `  DATABASE  ` : `  --instance  ` = `  INSTANCE  ` ) `  POLICY_FILE  ` \[ `  GCLOUD_WIDE_FLAG …  ` \]
