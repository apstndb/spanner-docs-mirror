---
name: documents/docs.cloud.google.com/sdk/gcloud/reference/spanner/samples/run
uri: https://docs.cloud.google.com/sdk/gcloud/reference/spanner/samples/run
title: gcloud spanner samples run
...
Each Cloud Spanner sample application includes a backend gRPC service backed by a Cloud Spanner database and a workload script that generates service traffic. This command creates and initializes the Cloud Spanner database and runs both the backend service and workload script.
