---
name: documents/docs.cloud.google.com/spanner/docs/cloud-run-remote-function
uri: https://docs.cloud.google.com/spanner/docs/cloud-run-remote-function
title: Spanner remote functions
...
1.  [Create an HTTPS endpoint](https://docs.cloud.google.com/spanner/docs/cloud-run-remote-function#create-endpoint) in Cloud Run functions or Cloud Run.
    
      - If you are new to remote functions, we recommend using Cloud Run functions.

2.  [Create a remote function](https://docs.cloud.google.com/spanner/docs/cloud-run-remote-function#create-a-remote-function) in Spanner pointing to that HTTPS endpoint.

3.  [Use the remote function](https://docs.cloud.google.com/spanner/docs/cloud-run-remote-function#use-remote-function) in a query.
...
If you have created remote functions for [BigQuery](https://docs.cloud.google.com/bigquery/docs/remote-functions) , you can reuse them for Spanner.
