...
You can check the status of your dual-region quorum in the following ways:
  ...
  - [On the **Database overview** page](https://docs.cloud.google.com/spanner/docs/change-dual-region-quorum#database-overview)
  - [Use the System insights dashboard](https://docs.cloud.google.com/spanner/docs/change-dual-region-quorum#system-insights)
  - [Use a Cloud Monitoring REST API or Google Cloud CLI](https://docs.cloud.google.com/spanner/docs/change-dual-region-quorum#rest-gcloud)
...
After you create a dual-region configuration, you can view the [Dual-region quorum health timeline](https://docs.cloud.google.com/spanner/docs/monitoring-console#system_insights_scorecards_charts_and_metrics) metric on the Instance-level System insights dashboard.

For more information, see [View the system insights dashboard](https://docs.cloud.google.com/spanner/docs/monitoring-console#view_the_system_insights_dashboard) .
...
4.  Manually [failback](https://docs.cloud.google.com/spanner/docs/change-dual-region-quorum#failover) if your region was unhealthy and there was a failover.
...
## What's next
  ...
  - Learn more about [Dual-region instance configurations](https://docs.cloud.google.com/spanner/docs/instance-configurations#dual-region-configurations) .
