...
1.  [Determine whether inefficient queries are causing high CPU utilization.](https://docs.cloud.google.com/spanner/docs/using-query-insights#using-db-load-graph)
2.  [Identify a potentially problematic query or tag.](https://docs.cloud.google.com/spanner/docs/using-query-insights#filter-db-load)
3.  [Analyze the query or request tag to identify issues.](https://docs.cloud.google.com/spanner/docs/using-query-insights#specific-query)
...
Use [query parameters](https://docs.cloud.google.com/spanner/docs/sql-best-practices#query-parameters) or [tag your queries](https://docs.cloud.google.com/spanner/docs/introspection/troubleshooting-with-tags) to optimize Query insights performance. If you don't parameterize or tag your queries, then too many results might return, which might cause the TopN queries and tags table to not load properly.
...
![TopN queries](https://docs.cloud.google.com/static/spanner/docs/images/topn-queries-2.png)
...
We recommend that you [add tags to your SQL queries](https://docs.cloud.google.com/spanner/docs/introspection/troubleshooting-with-tags#request_tags) . Query tagging helps you find issues at higher-level constructs, such as with the business logic or a microservice.

![TopN queries table](https://docs.cloud.google.com/static/spanner/docs/images/topn-queries-table-2.png)
...
![Variance between graphs](https://docs.cloud.google.com/static/spanner/docs/images/variance.png)
...
![Query details page](https://docs.cloud.google.com/static/spanner/docs/images/query-details-v2.png)
