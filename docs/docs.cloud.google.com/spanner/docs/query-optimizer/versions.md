...
### Version 4: March 1st, 2022
  ...
  - Introduces single pass hash join, enabled by the new hint `hash_join_execution` .
    ...
    The new mode is beneficial when the [build side input of the hash join](https://docs.cloud.google.com/spanner/docs/query-execution-operators#hash-join) is large. One pass hash join is expected to have better performance when you observe the following in the [query execution profile](https://docs.cloud.google.com/spanner/docs/tune-query-with-visualizer) :
...
### Version 3: August 1st, 2021
  ...
  - Adds a new join algorithm, merge join, enabled using a new [JOIN METHOD](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/query-syntax#join-methods) query hint value.
  ...
  - Adds a new join algorithm, push broadcast hash join, enabled using a new [JOIN METHOD](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/query-syntax#join-methods) query hint value.
...
## What's next
  ...
  - To learn more about the query optimizer, see [About query optimizer](https://docs.cloud.google.com/spanner/docs/query-optimizer/overview) .
