...
Spanner default ← [database option](https://docs.cloud.google.com/spanner/docs/query-optimizer/manage-query-optimizer#db-option) ← [client app](https://docs.cloud.google.com/spanner/docs/query-optimizer/manage-query-optimizer#client-app) ← [environment variable](https://docs.cloud.google.com/spanner/docs/query-optimizer/manage-query-optimizer#environment-variable) ← [client query](https://docs.cloud.google.com/spanner/docs/query-optimizer/manage-query-optimizer#client-query) ← [statement hint](https://docs.cloud.google.com/spanner/docs/query-optimizer/manage-query-optimizer#statement-hint)

For example, here's how to interpret the order of precedence when setting the query optimizer version:

When you create a database, it uses the Spanner [default optimizer version](https://docs.cloud.google.com/spanner/docs/query-optimizer/manage-query-optimizer#default_version) . Setting the optimizer version using one of the methods listed previously takes precedence over anything to the left of it. For example, setting the optimizer for an app using an [environment variable](https://docs.cloud.google.com/spanner/docs/query-optimizer/manage-query-optimizer#environment-variable) takes precedence over any value you set for the database using the [database option](https://docs.cloud.google.com/spanner/docs/query-optimizer/manage-query-optimizer#db-option) . Setting the optimizer version through a [statement hint](https://docs.cloud.google.com/spanner/docs/query-optimizer/manage-query-optimizer#statement-hint) has the highest precedence for the given query, taking precedence over the value set using any other method.
...
To learn how to use Cloud Monitoring to monitor your Spanner instances, see [Monitoring with Cloud Monitoring](https://docs.cloud.google.com/spanner/docs/monitoring-cloud)
