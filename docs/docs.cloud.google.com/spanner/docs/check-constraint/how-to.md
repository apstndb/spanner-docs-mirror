...
Spanner's [INFORMATION\_SCHEMA](https://docs.cloud.google.com/spanner/docs/information-schema) contains information about the check constraints on your database. The following are some examples of the questions you can answer by querying the information schema.
