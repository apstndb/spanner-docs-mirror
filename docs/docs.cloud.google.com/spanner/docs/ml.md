...
To use the functions, you can select a model from the [Agent Platform Model Garden](https://docs.cloud.google.com/vertex-ai/docs/start/explore-models) or use a model that you've deployed to Agent Platform.

For more information on how to deploy a model to an endpoint in Agent Platform, see [Deploy a model to an endpoint](https://docs.cloud.google.com/vertex-ai/docs/general/deployment) .
