---
name: documents/docs.cloud.google.com/spanner/docs/modifying-leader-region
uri: https://docs.cloud.google.com/spanner/docs/modifying-leader-region
...
To view data on the database leader distribution of a dual-region or multi-region instance, open the Google Cloud console, and refer to the **Leader distribution** charts. For more information, see [Spanner charts and metrics](https://docs.cloud.google.com/spanner/docs/monitoring-console#charts-metrics) .

## Change the leader region of a database

You can change the leader region of a database. To monitor the progress of this change, you can refer to the [Leader distribution chart](https://docs.cloud.google.com/spanner/docs/monitoring-console#charts-metrics) .
