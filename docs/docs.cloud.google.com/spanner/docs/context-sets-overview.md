---
name: documents/docs.cloud.google.com/spanner/docs/context-sets-overview
uri: https://docs.cloud.google.com/spanner/docs/context-sets-overview
title: Context sets overview
