...
To get the permissions that you need to view or modify insights dashboards, including custom dashboards, ask your administrator to grant you the following IAM roles on the project:
  ...
  - To access metrics generated by your Spanner project: [Cloud Spanner Viewer](https://docs.cloud.google.com/iam/docs/roles-permissions/spanner#spanner.viewer) ( `roles/spanner.viewer` )
  ...
  - To open and view Metrics Explorer charts, including custom dashboards: [Monitoring Dashboard Configuration Viewer](https://docs.cloud.google.com/iam/docs/roles-permissions/monitoring#monitoring.dashboardViewer) ( `roles/monitoring.dashboardViewer` )
  ...
  - To view the system insights page: [Cloud Spanner Database Reader](https://docs.cloud.google.com/iam/docs/roles-permissions/spanner#spanner.databaseReader) ( `roles/spanner.databaseReader` )
  - To view the logs generated by managed autoscaler: [Logs Viewer](https://docs.cloud.google.com/iam/docs/roles-permissions/logging#logging.viewer) ( `roles/logging.viewer` )
...
The following permissions are required to view or modify insights dashboards, including custom dashboards:
  ...
  - To access metrics generated by your Spanner project: `monitoring.timeSeries.list`
  ...
  - To view the system insights page: `spanner.databases.beginReadOnlyTransaction, spanner.databases.select, spanner.sessions.create`
  - To view the logs generated by managed autoscaler: `logging.logEntries.list, logging.logs.list, logging.logServices.list`
