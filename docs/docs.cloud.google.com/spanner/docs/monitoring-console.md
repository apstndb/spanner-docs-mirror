...
1.  **Insight selectors:** Select the databases, [instance partitions](https://docs.cloud.google.com/spanner/docs/geo-partitioning) , and regions that populate the dashboard. System insights shows instance partitions and region selections when multiple instance partitions or regions are available in the instance.
...
![System insights dashboard with numbered elements described in the prior list](https://docs.cloud.google.com/static/spanner/docs/images/console/system_insights_dashboard2.png)
...
![Chart screenshot of CPU utilization by operation type, with elements described in the following section.](https://docs.cloud.google.com/static/spanner/docs/images/console/sysinsights--x8ve9mgosd.png)
...
<br />
To failover and failback manually, see <a href="https://docs.cloud.google.com/spanner/docs/change-dual-region-quorum">Change dual-region quorum</a> .</td>
<td><br />
<em>done</em></td>
<td><br />
<em>done</em></td>
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/cpu/utilization_by_priority</a></td>
<td><br />
...
<br />
<a href="https://docs.cloud.google.com/spanner/docs/cpu-utilization#task-priority">Learn more about high-priority tasks</a> .<br />
<a href="https://docs.cloud.google.com/spanner/docs/cpu-utilization">Learn more about CPU utilization.</a></td>
<td><br />
<em>done</em></td>
<td><br />
<em>close</em></td>
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/cpu/utilization_by_operation_type</a></td>
<td><br />
A stacked chart of CPU utilization as a percentage of the instance's CPU resources, grouped by user-initiated operations such as reads, writes, and commits. Use this metric to get a detailed breakdown of CPU usage and to troubleshoot further, as explained in <a href="https://docs.cloud.google.com/spanner/docs/introspection/investigate-cpu-utilization">Investigate high CPU utilization</a> .<br />
<br />
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/cpu/smoothed_utilization</a></td>
<td><br />
A rolling average of total <a href="https://docs.cloud.google.com/spanner/docs/cpu-utilization">CPU Spanner utilization</a> , as a percentage of the instance's CPU resources, for each database. Each data point is an average for the previous 24 hours.</td>
<td><br />
<em>done</em></td>
<td><br />
<em>close</em></td>
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">api/request_latencies</a></td>
<td><br />
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">api/request_latencies_by_transaction_type</a></td>
<td><br />
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">api/api_request_count</a></td>
<td><br />
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">api/sent_bytes_count</a> (read)<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">api/received_bytes_count</a> (write)</td>
<td><br />
...
<br />
Read throughput includes requests and responses for methods in the <a href="https://docs.cloud.google.com/spanner/docs/reads">read API</a> and for SQL queries. It also includes requests and responses for DML statements.<br />
<br />
Write throughput includes requests and responses to commit data through the <a href="https://docs.cloud.google.com/spanner/docs/modify-mutation-api">mutation API</a> . It excludes requests and responses for DML statements.</td>
<td><br />
<em>close</em></td>
<td><br />
<em>done</em></td>
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/storage/used_bytes</a></td>
<td><br />
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/backup/used_bytes</a></td>
<td><br />
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">lock_stat/total/lock_wait_time</a></td>
<td><br />
Lock wait time for a transaction is the time needed to acquire a lock on a resource held by another transaction.<br />
<br />
Total lock wait time for <a href="https://docs.cloud.google.com/spanner/docs/introspection/lock-statistics">lock</a> conflicts is recorded for the entire database.</td>
<td><br />
<em>close</em></td>
<td><br />
<em>done</em></td>
...
<br />
Total lock wait time for <a href="https://docs.cloud.google.com/spanner/docs/introspection/lock-statistics">lock</a> conflicts is recorded for the entire instance.</td>
<td><br />
<em>done</em></td>
<td><br />
<em>close</em></td>
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/processing_units</a><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/nodes</a></td>
<td><br />
The <a href="https://docs.cloud.google.com/spanner/docs/compute-capacity">compute capacity</a> is the amount of processing units or nodes available in an instance. You can choose to display the capacity in processing units or in nodes.</td>
<td><br />
<em>done</em></td>
<td><br />
<em>close</em></td>
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/leader_percentage_by_region</a></td>
<td><br />
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/peak_split_peak</a></td>
<td>The maximum peak split CPU usage observed across all splits in a database. This metric shows the percentage of the processing unit resources that are being used on a split. A percentage of over 50% is a warm split, which means that the split is using half of the host server's processing unit resources. A percentage of 100% is a hot split, which is a split that's using the majority of the host server's processing unit resources. Spanner uses load-based splitting to resolve hotspots and balance the load. However, Spanner might not be able to balance the load, even after multiple attempts at splitting, due to problematic patterns in the application. Hence, hotspots that lasts for at least 10 minutes might need further troubleshooting and could potentially require application changes. For more information, see <a href="https://docs.cloud.google.com/spanner/docs/introspection/hot-split-statistics">Find hotspots in splits</a> .</td>
<td><br />
<em>done</em></td>
<td><br />
<em>done</em></td>
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">query_stat/total/remote_service_calls_count</a></td>
<td><br />
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">query_stat/total/remote_service_calls_latencies</a></td>
<td><br />
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">query_stat/total/remote_service_processed_rows_count</a></td>
<td><br />
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">query_stat/total/remote_service_processed_rows_latencies</a></td>
<td><br />
...
<br />
<br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">query_stat/total/remote_service_network_bytes_sizes</a></td>
<td><br />
...
This chart obtains its data by querying the table operations statistics tables. For more information, see <a href="https://docs.cloud.google.com/spanner/docs/introspection/table-operations-statistics">Table operations statistics</a> .</td>
<td><br />
<em>close</em></td>
<td><br />
<em>done</em></td>
...
<tr class="odd">
<td><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/autoscaling/min_node_count</a></td>
<td><br />
Minimum number of nodes autoscaler is configured to allocate to the instance.</td>
</tr>
<tr class="even">
<td><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/autoscaling/max_node_count</a></td>
<td>Maximum number of nodes autoscaler is configured to allocate to the instance.</td>
</tr>
<tr class="odd">
<td><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/autoscaling/recommended_node_count_for_cpu</a></td>
<td><br />
Recommended number of nodes based on the CPU usage of the instance.</td>
</tr>
<tr class="even">
<td><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/autoscaling/recommended_node_count_for_storage</a></td>
<td><br />
...
<tr class="even">
<td><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/autoscaling/min_processing_units</a></td>
<td><br />
Minimum number of processing units autoscaler is configured to allocate to the instance.</td>
</tr>
<tr class="odd">
<td><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/autoscaling/max_processing_units</a></td>
<td><br />
Maximum number of processing units autoscaler is configured to allocate to the instance.</td>
</tr>
<tr class="even">
<td><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/autoscaling/recommended_processing_units_for_cpu</a></td>
<td><br />
Recommended number of processing units. This recommendation is based on the previous CPU usage of the instance.</td>
</tr>
<tr class="odd">
<td><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/autoscaling/recommended_processing_units_for_storage</a></td>
<td><br />
...
<tr class="odd">
<td><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/autoscaling/high_priority_cpu_utilization_target</a></td>
<td><br />
High priority CPU utilization target to use for autoscaling.</td>
</tr>
<tr class="even">
<td><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/autoscaling/total_cpu_utilization_target</a><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">replica/autoscaling/total_cpu_utilization_target</a></td>
<td><br />
...
<tr class="even">
<td><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/storage/limit_bytes</a></td>
<td><br />
Storage limit for the instance in bytes.</td>
</tr>
<tr class="odd">
<td><br />
<a href="https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner">instance/autoscaling/storage_utilization_target</a></td>
<td><br />
...
The following metrics are available for instances that use [tiered storage](https://docs.cloud.google.com/spanner/docs/tiered-storage) .

| Metric name and type                                                                                                               | Description                                                                |
| ---------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| [instance/storage/used\_bytes](https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner)                           | Total bytes of data stored on SSD and HDD storage.                         |
| [instance/storage/combined/limit\_bytes](https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner)                 | Combined SSD and HDD storage limits.                                       |
| [instance/storage/combined/limit\_per\_processing\_unit](https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner) | Combined SSD and HDD storage limit for each processing unit.               |
| [instance/storage/combined/utilization](https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner)                  | Combined SSD and HDD storage used, compared to the combined storage limit. |
| [instance/disk\_load](https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-spanner)                                    | HDD load use.                                                              |
...
4.  Optional: To control what data appears in the chart, click one of the lists in the chart. For example, if the instance uses a [dual-region or multi-region configuration](https://docs.cloud.google.com/spanner/docs/instances#configuration) , some charts provide a list to view data for a specific region. Not all charts have view lists.
...
## What's next
  ...
  - [Set up customized charts and alerts](https://docs.cloud.google.com/spanner/docs/monitoring-cloud) with Monitoring.
  - Get details about [types of Spanner instances](https://docs.cloud.google.com/spanner/docs/instances) .
