...
The [Scaler](https://github.com/cloudspannerecosystem/autoscaler/blob/main/src/scaler/README.md) evaluates the data points received from the Poller component, and determines whether you need to adjust the number of nodes or processing units and, if so, by how much. The compares the metric values to the threshold, plus or minus an allowed [margin](https://docs.cloud.google.com/spanner/docs/autoscaler-tool-overview#margins) , and adjusts the number of nodes or processing units based on the configured scaling method. For more details, see [Scaling methods](https://docs.cloud.google.com/spanner/docs/autoscaler-tool-overview#scaling_methods) .

Throughout the flow, the Autoscaler tool writes a summary of its recommendations and actions to [Cloud Logging](https://docs.cloud.google.com/logging) for tracking and auditing.
...
![Load pattern with multiple steps.](https://docs.cloud.google.com/static/spanner/docs/images/autoscaler-tool-stepwise.png)
...
![Load pattern with fluctuations.](https://docs.cloud.google.com/static/spanner/docs/images/autoscaler-tool-linear.png)
...
![Load pattern with direct scaling pre-provisioned.](https://docs.cloud.google.com/static/spanner/docs/images/autoscaler-tool-direct.png)
...
The Autoscaler tool has different configuration options that you can use to manage the scaling of your Spanner deployments. Though the Cloud Run functions and GKE parameters are similar, they are supplied differently. For more information on configuring the Autoscaler tool, see [Configuring a Cloud Run functions deployment](https://docs.cloud.google.com/spanner/docs/set-up-autoscaling-cloud-run#configuration) and [Configuring a GKE deployment](https://docs.cloud.google.com/spanner/docs/set-up-autoscaling-gke#configuration) .
