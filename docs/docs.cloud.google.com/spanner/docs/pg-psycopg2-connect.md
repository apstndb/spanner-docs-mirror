---
name: documents/docs.cloud.google.com/spanner/docs/pg-psycopg2-connect
uri: https://docs.cloud.google.com/spanner/docs/pg-psycopg2-connect
title: Connect psycopg2 to a PostgreSQL-dialect database
