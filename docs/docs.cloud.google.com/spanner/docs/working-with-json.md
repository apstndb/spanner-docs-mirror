...
You can accelerate querying JSON data by using [secondary indexes](https://docs.cloud.google.com/spanner/docs/secondary-indexes) and [search indexes](https://docs.cloud.google.com/spanner/docs/full-text-search/search-indexes) with your JSON data. Spanner doesn't support using JSON type columns as keys in secondary indexes.
...
For more information, see [JSON search indexes](https://docs.cloud.google.com/spanner/docs/full-text-search/json-indexes) .
...
## What's next
  ...
  - [JSON functions](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/json_functions)
  - JSON operators:
      - [Dot operator for field access](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/operators#field_access_operator)
      - [Subscript operator for field and array element access](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/operators#json_subscript_operator)
