---
name: documents/docs.cloud.google.com/spanner/docs/apis
uri: https://docs.cloud.google.com/spanner/docs/apis
...
---
  ...
  - [](https://docs.cloud.google.com/spanner/docs/use-oss-jdbc)
  ...
  - [](https://docs.cloud.google.com/spanner/docs/reference/mcp)
    ...
    Spanner's MCP reference.

  - [](https://docs.cloud.google.com/spanner/docs/reference/rpc)
  ...
  - [](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/lexical)
  ...
  - [](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/data-definition-language)
  ...
  - [](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/functions-all)
    
    ### GoogleSQL functions
    
    Reference for supported GoogleSQL functions.

  - [](https://docs.cloud.google.com/spanner/docs/reference/postgresql/lexical)
  ...
  - [](https://docs.cloud.google.com/spanner/docs/reference/postgresql/data-definition-language)
    
    ### PostgreSQL data definition language
    
    Reference for data definition language (DDL) statements in PostgreSQL databases.

  - [](https://docs.cloud.google.com/spanner/docs/reference/postgresql/dml-syntax)
    
    ### PostgreSQL data manipulation language
    
    Reference for data manipulation language (DML) statements in PostgreSQL databases.

  - [](https://docs.cloud.google.com/spanner/docs/reference/postgresql/query-syntax)
    
    ### PostgreSQL queries
    
    Reference for the SELECT statement in PostgreSQL databases.

  - [](https://docs.cloud.google.com/spanner/docs/reference/postgresql/subqueries)
  ...
  - [](https://docs.cloud.google.com/spanner/docs/reference/postgresql/functions-and-operators)
  ...
  - [](https://docs.cloud.google.com/spanner/docs/gcloud-spanner)
