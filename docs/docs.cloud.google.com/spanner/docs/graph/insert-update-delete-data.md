...
1.  [Create a Spanner instance](https://docs.cloud.google.com/spanner/docs/graph/set-up#create-instance) .

2.  [Create a database](https://docs.cloud.google.com/spanner/docs/graph/set-up#create-database) in your Spanner instance.

3.  [Insert graph data](https://docs.cloud.google.com/spanner/docs/graph/set-up#insert-graph-data) into your database.
...
To insert nodes or edges into node or edge tables, use [the Google Cloud console](https://docs.cloud.google.com/spanner/docs/modify-data) , the [gcloud CLI](https://docs.cloud.google.com/sdk/gcloud/reference/spanner) , or the [Spanner client libraries](https://docs.cloud.google.com/spanner/docs/reference/libraries) .

In the Google Cloud console and in the gcloud CLI, you can use GoogleSQL [Data Manipulation Language](https://docs.cloud.google.com/spanner/docs/dml-tasks#use-dml) (DML). In the Spanner client library, you can use DML or [Mutation APIs](https://docs.cloud.google.com/spanner/docs/modify-mutation-api) .
...
To update existing nodes or edges, use the [Google Cloud console](https://docs.cloud.google.com/spanner/docs/modify-data) , the [gcloud CLI](https://docs.cloud.google.com/sdk/gcloud/reference/spanner) , or the [Spanner client libraries](https://docs.cloud.google.com/spanner/docs/reference/libraries) .

You can update existing nodes or edges using a GoogleSQL [Data Manipulation Language](https://docs.cloud.google.com/spanner/docs/dml-tasks#use-dml) (DML) statement, or Spanner Graph queries with a DML statement. If you use a Spanner client library, you can also use [Mutation APIs](https://docs.cloud.google.com/spanner/docs/modify-mutation-api) .
...
To delete existing nodes or edges, use [the Google Cloud console](https://docs.cloud.google.com/spanner/docs/modify-data) , the [gcloud CLI](https://docs.cloud.google.com/sdk/gcloud/reference/spanner) , or the [Spanner client libraries](https://docs.cloud.google.com/spanner/docs/reference/libraries) .

In the the Google Cloud console and the gcloud CLI, you use GoogleSQL [Data Manipulation Language](https://docs.cloud.google.com/spanner/docs/dml-tasks#use-dml) (DML) to delete. In the Spanner client library, you can use DML or [Mutation APIs](https://docs.cloud.google.com/spanner/docs/modify-mutation-api) to delete nodes or edges.
