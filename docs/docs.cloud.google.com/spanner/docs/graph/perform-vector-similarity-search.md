---
name: documents/docs.cloud.google.com/spanner/docs/graph/perform-vector-similarity-search
uri: https://docs.cloud.google.com/spanner/docs/graph/perform-vector-similarity-search
title: Use vector search with Spanner Graph
...
To run the examples in this document, you must first follow the steps in [Set up and query Spanner Graph](https://docs.cloud.google.com/spanner/docs/graph/set-up) to do the following:

1.  [Create an instance](https://docs.cloud.google.com/spanner/docs/graph/set-up#create-instance) .
2.  [Create a database with a Spanner Graph schema](https://docs.cloud.google.com/spanner/docs/graph/set-up#create-database) .
3.  [Insert essential graph data](https://docs.cloud.google.com/spanner/docs/graph/set-up#insert-graph-data) .
...
3.  Create embeddings for the text in the `nick_name` column, and populate them into the new `nick_name_embeddings` column.
    ...
    To generate Gemini Enterprise Agent Platform embeddings for your operational data in Spanner Graph, see [Get Agent Platform text embeddings](https://docs.cloud.google.com/spanner/docs/ml-tutorial-embeddings) .
