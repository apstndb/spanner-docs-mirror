...
The following topics help you learn how:
  ...
  - [Create a Spanner instance](https://docs.cloud.google.com/spanner/docs/graph/set-up#create-instance) .

  - [Create a database with a Spanner Graph schema](https://docs.cloud.google.com/spanner/docs/graph/set-up#create-database) .

  - [Insert graph data](https://docs.cloud.google.com/spanner/docs/graph/set-up#insert-graph-data) .

  - [Query the graph you created](https://docs.cloud.google.com/spanner/docs/graph/set-up#run-graph-query) .

  - [Clean up resources](https://docs.cloud.google.com/spanner/docs/graph/set-up#clean-up) .
...
4.  On the **Select an edition** page, select **Enterprise Plus** or **Enterprise** .
    ...
    Spanner Graph is available only in the Enterprise edition or Enterprise Plus edition. To compare the different editions, click **Compare editions** . For more information, see the [Spanner editions overview](https://docs.cloud.google.com/spanner/docs/editions-overview) .
...
![Example graph.](https://docs.cloud.google.com/static/spanner/docs/images/spanner-graph-example-graph.png)
