...
update_time: "2026-05-10T05:41:01Z"
---
...
Directed reads offer the following benefits:
  ...
  - Enable workload isolation. You can direct your analytics workloads and [change streams reads](https://docs.cloud.google.com/spanner/docs/change-streams) to specific Spanner replicas to minimize impact to transactional workloads running on the same Spanner database.

## Supported query operations

| Query operations                                                                                          | Are directed reads supported? |
| --------------------------------------------------------------------------------------------------------- | ----------------------------- |
| [Stale read](https://docs.cloud.google.com/spanner/docs/reads#perform-stale-read)                         | Yes                           |
...
Spanner directed reads have the following limitations:
  ...
  - You can only use directed reads in a Spanner instance that is in a [dual-region instance configuration](https://docs.cloud.google.com/spanner/docs/instance-configurations#dual-region-configurations) or [multi-region instance configuration](https://docs.cloud.google.com/spanner/docs/instance-configurations#multi-region-configurations) or a [custom regional configuration with optional read-only region(s)](https://docs.cloud.google.com/spanner/docs/create-manage-configurations#create-configuration) .
  - You can't use directed reads with read-write requests because write requests are always served by the leader region.
  - You can't use directed reads in the Google Cloud console or Google Cloud CLI. It is available using [REST](https://docs.cloud.google.com/spanner/docs/directed-reads#rest) and [RPC](https://docs.cloud.google.com/spanner/docs/directed-reads#rpc) APIs and the Spanner client libraries.
...
## What's next
  ...
  - Learn how to perform [Reads outside of transactions](https://docs.cloud.google.com/spanner/docs/reads) .
