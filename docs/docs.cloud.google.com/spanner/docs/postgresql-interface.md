...
The following list provides more information on supported and unsupported PostgreSQL features:
  ...
  - **Some PostgreSQL language features aren't supported** : extensions, user-defined data types, user-defined stored procedures, and other features aren't supported. For a complete list, see [The PostgreSQL language in Spanner](https://docs.cloud.google.com/spanner/docs/reference/postgresql/overview) . There are also some features in PostgreSQL that behave differently from open source PostgreSQL. For more information, see [Known issues in the PostgreSQL interface for Spanner](https://docs.cloud.google.com/spanner/docs/reference/postgresql/known-issues-postgresql-interface) .
...
Spanner's PostgreSQL interface offers two primary features that enable integration with the PostgreSQL ecosystem:
  ...
  - **PostgreSQL dialect support**
    ...
    Spanner provides a subset of the PostgreSQL SQL dialect, including Data Query Language (DQL), Data Manipulation Language (DML), and Data Definition Language (DDL). Additionally, it includes extensions to support Spanner-specific features like [interleaved tables](https://docs.cloud.google.com/spanner/docs/schema-and-data-model#parent-child) , [time to live (TTL)](https://docs.cloud.google.com/spanner/docs/ttl) , and [query hints](https://docs.cloud.google.com/spanner/docs/reference/postgresql/query-syntax#pg_extensions) .
    
    For detailed information on the supported PostgreSQL language elements, see [The PostgreSQL language in Spanner](https://docs.cloud.google.com/spanner/docs/reference/postgresql/overview) . To understand how to use Spanner features with the PostgreSQL dialect, consult the documentation for the specific feature.
...
1.  **Connect your applications** : use the [set of supported PostgreSQL tools](https://docs.cloud.google.com/spanner/docs/postgresql-interface#connect-pg) for efficient connectivity.

2.  **Interact with your database** : for interactive work, choose between the following:
    
      - The familiar [psql command-line tool](https://docs.cloud.google.com/spanner/docs/psql-connect) (using the [PGAdapter proxy](https://docs.cloud.google.com/spanner/docs/pgadapter-get) )
      - The intuitive [Spanner Studio](https://docs.cloud.google.com/spanner/docs/manage-data-using-console) page within the Google Cloud console
      - IDEs, such [DBeaver](https://cloud.google.com/blog/topics/developers-practitioners/exploring-cloud-spanner-data-dbeaver/) and [Visual Studio Code](https://cloud.google.com/blog/topics/developers-practitioners/browse-and-query-cloud-spanner-databases-visual-studio-code) , [JetBrains](https://cloud.google.com/blog/topics/developers-practitioners/cloud-spanner-connectivity-using-jetbrains-ides) , and [IntelliJ](https://docs.cloud.google.com/spanner/docs/use-intellij)
