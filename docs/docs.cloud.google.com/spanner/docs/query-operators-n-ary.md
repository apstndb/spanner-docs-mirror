...
The union all operator combines its input rows, and in this example it sends the results to a [serialize result](/spanner/docs/query-operators-unary#serialize_result) operator.
