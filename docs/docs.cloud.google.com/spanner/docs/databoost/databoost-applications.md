...
For examples of using Data Boost in your application code, see [Read data in parallel](https://docs.cloud.google.com/spanner/docs/reads#read_data_in_parallel) .
