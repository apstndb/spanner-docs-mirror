...
In this tutorial, you learn how to:
  ...
  - Use Google provided Gemini Enterprise Agent Platform [Generative AI](https://docs.cloud.google.com/gemini-enterprise-agent-platform/overview) models in a Spanner database.
  - Use [Generative AI](https://docs.cloud.google.com/gemini-enterprise-agent-platform/overview) to provide personalized product recommendations in a sample ecommerce application.
...
For more information about Agent Platform costs, see the [Agent Platform pricing](https://docs.cloud.google.com/products/gemini-enterprise-agent-platform/pricing) page.
...
In this tutorial, we use the Agent Platform [text-bison](https://docs.cloud.google.com/gemini-enterprise-agent-platform/reference/models/text-embeddings-api) model to provide personalized product recommendations to end customers. To register this model in a Spanner database, [execute](https://docs.cloud.google.com/spanner/docs/schema-updates) the following DDL [statement](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/data-definition-language#create_model) :
