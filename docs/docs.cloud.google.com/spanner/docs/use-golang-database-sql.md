...
To get the best possible performance when using the Spanner database/sql driver, follow these best practices:
  ...
  - Tags: [Use request and transaction tags](https://github.com/googleapis/go-sql-spanner/blob/-/examples/tags/main.go) to [troubleshoot](https://docs.cloud.google.com/spanner/docs/introspection/troubleshooting-with-tags) .
...
## What's next
  ...
  - Use [GORM with Spanner](https://docs.cloud.google.com/spanner/docs/use-gorm) .
