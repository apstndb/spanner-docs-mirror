...
1.  [Install the Google Cloud CLI](https://docs.cloud.google.com/sdk/docs/install) or use [Cloud Shell](https://docs.cloud.google.com/shell/docs/launching-cloud-shell) , which has all the necessary tools pre-installed.
...
The following instructions are performed using the [BigQuery reverse ETL](https://docs.cloud.google.com/bigquery/docs/export-to-spanner) workflow and the [Google Cloud CLI](https://docs.cloud.google.com/sdk) .
...
4.  Create a Spanner schema that matches the imported BQ\_TABLE by using the following command:
    ...
    For more information, see [Update Spanner schema](https://docs.cloud.google.com/spanner/docs/getting-started/gcloud#create-database) .
