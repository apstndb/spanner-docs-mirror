---
name: documents/docs.cloud.google.com/spanner/docs/reference/standard-sql/lexical
uri: https://docs.cloud.google.com/spanner/docs/reference/standard-sql/lexical
