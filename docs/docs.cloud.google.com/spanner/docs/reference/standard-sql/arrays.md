...
You can construct an array using array literals or array functions. To learn more about constructing arrays, see [Array type](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/data-types#constructing_an_array) .
