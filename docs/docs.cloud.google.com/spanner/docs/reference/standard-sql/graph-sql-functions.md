---
name: documents/docs.cloud.google.com/spanner/docs/reference/standard-sql/graph-sql-functions
uri: https://docs.cloud.google.com/spanner/docs/reference/standard-sql/graph-sql-functions
title: GQL functions
