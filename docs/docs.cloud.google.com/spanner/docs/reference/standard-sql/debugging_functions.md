---
name: documents/docs.cloud.google.com/spanner/docs/reference/standard-sql/debugging_functions
uri: https://docs.cloud.google.com/spanner/docs/reference/standard-sql/debugging_functions
title: Debugging functions in GoogleSQL
