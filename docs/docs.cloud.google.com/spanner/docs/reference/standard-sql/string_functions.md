...
Identical to [TRIM](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/string_functions#trim) , but only removes leading characters.
...
Identical to [TRIM](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/string_functions#trim) , but only removes trailing characters.
