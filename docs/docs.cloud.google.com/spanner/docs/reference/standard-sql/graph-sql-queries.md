---
name: documents/docs.cloud.google.com/spanner/docs/reference/standard-sql/graph-sql-queries
uri: https://docs.cloud.google.com/spanner/docs/reference/standard-sql/graph-sql-queries
title: Graphs within SQL
