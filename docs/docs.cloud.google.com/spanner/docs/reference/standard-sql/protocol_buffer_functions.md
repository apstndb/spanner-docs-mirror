---
name: documents/docs.cloud.google.com/spanner/docs/reference/standard-sql/protocol_buffer_functions
uri: https://docs.cloud.google.com/spanner/docs/reference/standard-sql/protocol_buffer_functions
title: Protocol buffer functions in GoogleSQL
