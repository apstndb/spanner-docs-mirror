---
name: documents/docs.cloud.google.com/spanner/docs/reference/standard-sql/graph-operators
uri: https://docs.cloud.google.com/spanner/docs/reference/standard-sql/graph-operators
title: GQL operators
