---
name: documents/docs.cloud.google.com/spanner/docs/reference/standard-sql/operators
uri: https://docs.cloud.google.com/spanner/docs/reference/standard-sql/operators
title: Operators in GoogleSQL
