---
name: documents/docs.cloud.google.com/spanner/docs/reference/standard-sql/graph-intro
uri: https://docs.cloud.google.com/spanner/docs/reference/standard-sql/graph-intro
title: GQL overview
