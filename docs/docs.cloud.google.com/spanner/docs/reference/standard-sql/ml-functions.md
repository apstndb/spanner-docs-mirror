...
> **Note:** Make sure that Spanner has access to the referenced Gemini Enterprise Agent Platform endpoint as described in [Model endpoint access control](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/data-definition-language#create_model_permissions) .
