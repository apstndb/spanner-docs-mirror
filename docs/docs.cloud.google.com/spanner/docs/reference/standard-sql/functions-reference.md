---
name: documents/docs.cloud.google.com/spanner/docs/reference/standard-sql/functions-reference
uri: https://docs.cloud.google.com/spanner/docs/reference/standard-sql/functions-reference
