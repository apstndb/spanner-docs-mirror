---
name: documents/docs.cloud.google.com/spanner/docs/reference/standard-sql/array_functions
uri: https://docs.cloud.google.com/spanner/docs/reference/standard-sql/array_functions
title: Array functions in GoogleSQL
...
The `ARRAY` function returns an `ARRAY` with one element for each row in a [subquery](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/subqueries) .
...
**Constraints**
  ...
  - If the subquery returns an `ARRAY` typed column or `ARRAY` typed rows, the `ARRAY` function returns an error that GoogleSQL doesn't support `ARRAY` s with elements of type [`ARRAY`](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/data-types#array_type) .
...
Takes an array, filters out unwanted elements, and returns the results in a new array.
  ...
  - `lambda_expression` : Each element in `array_expression` is evaluated against the [lambda expression](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/functions-reference#lambdas) . If the expression evaluates to `FALSE` or `NULL` , the element is removed from the resulting array.
...
## `ARRAY_INCLUDES`
  ...
  - [Signature 1](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/array_functions#array_includes_signature1) : `ARRAY_INCLUDES(array_to_search, search_value)`
  - [Signature 2](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/array_functions#array_includes_signature2) : `ARRAY_INCLUDES(array_to_search, lambda_expression)`
...
Takes an array and returns `TRUE` if the lambda expression evaluates to `TRUE` for any element in the array.
  ...
  - `array_to_search` : The array to search.
  - `lambda_expression` : Each element in `array_to_search` is evaluated against the [lambda expression](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/functions-reference#lambdas) .
  - `element_alias` : An alias that represents an array element.
...
In the input array, `ARRAY<T>` , `T` can be an [orderable data type](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/data-types#data_type_properties) .
...
The `GENERATE_DATE_ARRAY` function returns an error if any of the following are true:
  ...
  - The resulting array exceeds the maximum size allowed by the engine. The GoogleSQL default limit is 16,000 elements, though individual query engines may configure a different limit.
...
For information about using `OFFSET` and `ORDINAL` with arrays, see [Array subscript operator](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/operators#array_subscript_operator) and [Accessing array elements](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/arrays#accessing_array_elements) .
