...
<tbody>
<tr class="odd">
<td><pre dir="ltr" data-is-upgraded="" style="border: 0;margin: 0;" translate="no"><code>{&quot;databaseId&quot;: string,&quot;encryptionConfig&quot;: {object (RestoreDatabaseEncryptionConfig)},// Union field source can be only one of the following:&quot;backup&quot;: string// End of list of possible types for union field source.}</code></pre></td>
</tr>
</tbody>
</table>
