...
<tbody>
<tr class="odd">
<td><pre dir="ltr" data-is-upgraded="" style="border: 0;margin: 0;" translate="no"><code>{// Union field selector can be only one of the following:&quot;singleUse&quot;: {object (TransactionOptions)},&quot;id&quot;: string,&quot;begin&quot;: {object (TransactionOptions)}// End of list of possible types for union field selector.}</code></pre></td>
</tr>
</tbody>
</table>
