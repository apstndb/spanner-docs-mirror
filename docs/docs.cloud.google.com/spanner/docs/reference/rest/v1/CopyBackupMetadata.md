---
name: documents/docs.cloud.google.com/spanner/docs/reference/rest/v1/CopyBackupMetadata
uri: https://docs.cloud.google.com/spanner/docs/reference/rest/v1/CopyBackupMetadata
title: CopyBackupMetadata
description: A managed, mission-critical, globally consistent and scalable relational database service.
data_source: docs.cloud.google.com
update_time: "2025-10-17T23:52:19Z"
---

  - [JSON representation](https://docs.cloud.google.com/spanner/docs/reference/rest/v1/CopyBackupMetadata#SCHEMA_REPRESENTATION)
...
<tbody>
<tr class="odd">
<td><pre dir="ltr" data-is-upgraded="" style="border: 0;margin: 0;" translate="no"><code>{&quot;name&quot;: string,&quot;sourceBackup&quot;: string,&quot;progress&quot;: {object (OperationProgress)},&quot;cancelTime&quot;: string}</code></pre></td>
</tr>
</tbody>
</table>
