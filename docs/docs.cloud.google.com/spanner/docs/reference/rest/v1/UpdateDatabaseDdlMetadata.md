...
<tbody>
<tr class="odd">
<td><pre dir="ltr" data-is-upgraded="" style="border: 0;margin: 0;" translate="no"><code>{&quot;database&quot;: string,&quot;statements&quot;: [string],&quot;commitTimestamps&quot;: [string],&quot;throttled&quot;: boolean,&quot;progress&quot;: [{object (OperationProgress)}],&quot;actions&quot;: [{object (DdlStatementActionInfo)}]}</code></pre></td>
</tr>
</tbody>
</table>
