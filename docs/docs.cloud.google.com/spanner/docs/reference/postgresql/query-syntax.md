...
Spanner has extensions for [statement hints](https://docs.cloud.google.com/spanner/docs/reference/postgresql/query-syntax#statement-hints) , [table hints](https://docs.cloud.google.com/spanner/docs/reference/postgresql/query-syntax#table-hints) , and [join hints](https://docs.cloud.google.com/spanner/docs/reference/postgresql/query-syntax#join-hints) .
