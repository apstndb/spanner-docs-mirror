---
name: documents/docs.cloud.google.com/spanner/docs/reference/mcp/databaseinsights/mcp
uri: https://docs.cloud.google.com/spanner/docs/reference/mcp/databaseinsights/mcp
title: 'MCP Reference: databaseinsights.googleapis.com'
