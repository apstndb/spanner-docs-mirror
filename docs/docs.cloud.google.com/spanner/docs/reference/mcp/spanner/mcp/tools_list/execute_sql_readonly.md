---
name: documents/docs.cloud.google.com/spanner/docs/reference/mcp/spanner/mcp/tools_list/execute_sql_readonly
uri: https://docs.cloud.google.com/spanner/docs/reference/mcp/spanner/mcp/tools_list/execute_sql_readonly
...
<tbody>
<tr class="odd">
<td><pre dir="ltr" data-is-upgraded="" style="border: 0;margin: 0;" translate="no"><code>{&quot;name&quot;: string,&quot;value&quot;: value,&quot;type&quot;: {object (Type)}}</code></pre></td>
</tr>
</tbody>
</table>
...
The value of the parameter. Use `string_value` for integers.

`type`

` object ( Type  ` )

It is not always possible for Spanner to infer the right SQL type from a JSON value. For example, values of type `BYTES` and values of type `STRING` are encoded in JSON as strings. Recommendation: set the type of the parameter.
