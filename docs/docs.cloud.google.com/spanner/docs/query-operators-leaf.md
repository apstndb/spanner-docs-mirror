---
name: documents/docs.cloud.google.com/spanner/docs/query-operators-leaf
uri: https://docs.cloud.google.com/spanner/docs/query-operators-leaf
title: Leaf operators
