---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-create-table-with-timestamp-column
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-create-table-with-timestamp-column
title: Create table with TIMESTAMP column
description: Create a table with a TIMESTAMP column.
