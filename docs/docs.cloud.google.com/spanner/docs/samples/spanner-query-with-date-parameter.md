---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-query-with-date-parameter
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-query-with-date-parameter
title: Query with DATE parameter
description: Query data by using a DATE parameter.
