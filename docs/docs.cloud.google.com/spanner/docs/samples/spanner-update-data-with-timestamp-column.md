---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-update-data-with-timestamp-column
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-update-data-with-timestamp-column
title: Mutations update data with TIMESTAMP
description: Update data in a table containing a TIMESTAMP column by using mutations.
...
For detailed documentation that includes this code sample, see the following:
  ...
  - [Commit timestamps in GoogleSQL-dialect databases](https://docs.cloud.google.com/spanner/docs/commit-timestamp)
