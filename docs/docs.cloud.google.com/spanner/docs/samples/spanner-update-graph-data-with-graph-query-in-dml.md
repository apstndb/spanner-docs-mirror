---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-update-graph-data-with-graph-query-in-dml
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-update-graph-data-with-graph-query-in-dml
title: Update graph data with a graph query
description: Update data in a Spanner Graph using a graph query.
