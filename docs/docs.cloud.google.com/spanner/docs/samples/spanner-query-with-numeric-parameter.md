---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-query-with-numeric-parameter
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-query-with-numeric-parameter
title: Query with NUMERIC parameter
description: Query data by using a NUMERIC parameter.
