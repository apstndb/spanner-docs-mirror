---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-create-struct-with-data
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-create-struct-with-data
