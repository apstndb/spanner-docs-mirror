---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-create-index
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-create-index
title: Create index
