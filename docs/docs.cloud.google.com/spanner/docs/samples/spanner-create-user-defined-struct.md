---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-create-user-defined-struct
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-create-user-defined-struct
