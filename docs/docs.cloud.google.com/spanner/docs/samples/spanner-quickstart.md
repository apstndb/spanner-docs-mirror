---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-quickstart
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-quickstart
title: Quickstart
description: Use a basic SELECT query.
