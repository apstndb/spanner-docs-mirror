---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-create-client-with-query-options
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-create-client-with-query-options
