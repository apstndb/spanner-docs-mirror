---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-jdbc-create-table
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-jdbc-create-table
