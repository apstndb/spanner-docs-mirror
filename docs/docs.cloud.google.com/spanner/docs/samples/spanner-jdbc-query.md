---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-jdbc-query
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-jdbc-query
title: JDBC query
description: Run a query by using JDBC.
