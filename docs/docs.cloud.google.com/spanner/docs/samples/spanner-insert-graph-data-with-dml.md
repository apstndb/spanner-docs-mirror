---
name: documents/docs.cloud.google.com/spanner/docs/samples/spanner-insert-graph-data-with-dml
uri: https://docs.cloud.google.com/spanner/docs/samples/spanner-insert-graph-data-with-dml
title: Insert graph data with DML
description: Insert data into a Spanner Graph using DML.
