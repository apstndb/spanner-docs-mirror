...
With the Agent Platform text embeddings API, you can create a text embedding with [Generative AI](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/overview) . In this tutorial, you use the Agent Platform text embedding model to generate text embeddings for the data stored in Spanner.
...
In this tutorial, you learn how to:
  ...
  - Register a [Agent Platform text embedding model](https://docs.cloud.google.com/vertex-ai/generative-ai/docs/embeddings/get-text-embeddings#supported-models) in a Spanner schema using DDL statements.
...
Depending on the model you use, generating embeddings might take some time. For more performance sensitive workloads, the best practice is to avoid generating embeddings in read-write transactions. Instead, generate the embeddings in a [read-only transaction](https://docs.cloud.google.com/spanner/docs/samples/spanner-read-only-transaction) using the following SQL examples.
...
After generating the embeddings in a read-only transaction, store them in Spanner so they can be managed with your operational data. To store the embeddings, use a [read-write transaction](https://docs.cloud.google.com/spanner/docs/samples/spanner-read-write-transaction) .
...
## What's next
  ...
  - Learn [how to use Agent Platform Vector Search](https://docs.cloud.google.com/vertex-ai/docs/vector-search/overview) to search for semantically similar items.
