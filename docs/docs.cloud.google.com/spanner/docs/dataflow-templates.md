...
Use the following templates to process data in bulk:
  ...
  - [Spanner to Gemini Enterprise Agent Platform Vector Search files on Cloud Storage](https://docs.cloud.google.com/dataflow/docs/guides/templates/provided/cloud-spanner-to-vertex-vector-search)
