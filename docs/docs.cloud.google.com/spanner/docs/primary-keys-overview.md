...
For more information on choosing a primary key to prevent hotspots, see [Schema design best practices](https://docs.cloud.google.com/spanner/docs/schema-design#primary-key-prevent-hotspots) .
...
You can use the `GENERATE_UUID()` function ( [GoogleSQL](https://docs.cloud.google.com/spanner/docs/reference/standard-sql/utility-functions#generate_uuid) , [PostgreSQL](https://docs.cloud.google.com/spanner/docs/reference/postgresql/functions-and-operators#utility) ) on Spanner to migrate UUID key databases.

For instructions on migrating UUID key databases, see [Migrate UUID key columns](https://docs.cloud.google.com/spanner/docs/migrating-primary-keys#migrate-uuid-key-columns) .
...
For instructions on migrating databases that have sequential keys, see [Migrate auto-generated sequential primary keys](https://docs.cloud.google.com/spanner/docs/migrating-primary-keys#migrate-auto-generated-sequential-keys) .
...
For instructions on migrating databases that have live cutover support, see [Use Spanner and your source database](https://docs.cloud.google.com/spanner/docs/migrating-primary-keys#use-spanner-source-db) .
...
For instructions on migrating sequential key databases with application logic dependencies, see [Migrate your own primary keys](https://docs.cloud.google.com/spanner/docs/migrating-primary-keys#migrate-own-primary-keys) .
